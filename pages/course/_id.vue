        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14">主讲： {{courseWebVo.psychologistName}}&nbsp;&nbsp;&nbsp;</span>
            </section>
            <!-- 收藏功能 -->
                ...
                <ul style="height: auto;">
                  <li>
                    ...
                    <section class="hLh30 txtOf">
                      <a class="c-333 fsize16 fl" :href="'/teacher/'+courseWebVo.psychologistId">{{courseWebVo.psychologistName}}</a>
                    </section>
