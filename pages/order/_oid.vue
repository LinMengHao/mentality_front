  ...
  <div class="Page Confirm">
    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      <table class="GoodList">
       ...
       <tr>
          <td colspan="3" class="teacher">心理讲师：{{order.psychologistName}}</td>
        </tr>
        <tr class="good">
          <td class="name First">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          <el-checkbox v-model="agree">我已阅读并同意<a href="javascript:" target="_blank">《MandMentality购买协议》</a></el-checkbox>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
