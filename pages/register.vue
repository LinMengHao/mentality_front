  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend" prop="password1" :rules="[{ required: true, message: '请输入密码', trigger: 'blur' },{validator: checkPassword, trigger: 'blur'}]">
          <div>
            <el-input type="password" placeholder="确认密码" v-model="params.password1"/>
            <i class="iconfont icon-password"/>
          </div>
        </el-form-item>
