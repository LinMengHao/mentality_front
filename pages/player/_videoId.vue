...
export default {
    ...
    mounted() {
        new Aliplayer({
            ...
            height: '500px',
            // 以下可选设置
            cover: 'https://edu-manager-lmh.oss-cn-beijing.aliyuncs.com/2021/01/27/6d13e679ac7a4555bc9ba86781e96a901586528907060.jpeg', // 封面
            ...
            components: [{
                ...
                /** 跑马灯组件三个参数 text, style, bulletPosition
                   ...
                   */
                args: ['欢迎来到MandMentality', { fontSize: '18px', color: '#ffaa00' }, 'random']
            },]
        }, function(player) {
            console.log('播放器创建成功')
        })
